...
export class AnimeListComponent implements OnInit {
	...
	public navCase: number //1 = advancedSearch, 2 = search, 3 = default

	constructor(private route: ActivatedRoute, private animeService: AnimeService, private router: Router) {}

	ngOnInit(): void {
		this.initPage()
		this.animeService.getAllGenres().subscribe((data) => (this.listGenres = data))
		this.animeService.getAllStudios().subscribe((data) => (this.listStudios = data))
		this.animeService.getAllProducers().subscribe((data) => (this.listProducers = data))
	}
	...
	initPage(): void {
		this.route.queryParams.subscribe((data) => {
			...
			if (this.queryParams.page) {
				...
				if (this.queryParams.genre || this.queryParams.studio || this.queryParams.producer) {
					this.animeService
						.getAllPagesByAdvancedSearch(this.queryParams.genre, this.queryParams.studio, this.queryParams.producer)
						.subscribe((pages) => {
							this.pages = pages
